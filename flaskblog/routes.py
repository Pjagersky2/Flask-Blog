...
def new_post() -> str:
    ...
    Process for when a user creates a new post.
    """
...
def post(post_id) -> str:
    ...
    Process for viewing a single post.
    """
...
@app.route("/user/<string:username>")  # both paths take you to the same place
